...
(function () {
    ...
    /***/function (module, exports, __webpack_require__) {
        ...
        // module
        exports.push([module.i, ":host{display:inline-block;margin-left:20px}#search-icon{width:19px;height:19px}button{background-color:var(--byu-search-color,#767676);border:1px solid var(--byu-search-color,#767676);color:#fff;width:30px;height:30px}#search-form{display:flex;align-items:stretch;align-content:center}#search-form #search-container{flex:1}#search-form #search-container ::slotted(input),#search-form #search-container input{padding:5px 10px;border:none}:host(.mobile-view){width:100%;height:35px;margin:0}:host(.mobile-view) #search-form #search-container ::slotted(input),:host(.mobile-view) #search-form #search-container input{padding:5px 10px;width:100%;height:35px;border:none;border-bottom:1px solid #c5c5c5}:host(.mobile-view) #search-button{width:53px;padding:0 16px;height:35px}:host(.mobile-view) #search-icon{width:20px;height:20px}", ""]);
    ...
    /***/function (module, exports, __webpack_require__) {
        ...
        module.exports = function anonymous(locals, escapeFn, include, rethrow) {
            ...
            __append(__webpack_require__(38));
    ...
    /***/function (module, exports, __webpack_require__) {
        ...
        module.exports = "<style>" + __webpack_require__(17) + "</style> <div id=\"search-form\"> <div id=\"search-container\"> <slot id=\"search\"><input type=\"search\" placeholder=\"Search\"></slot> </div> <button id=\"search-button\" type=\"submit\"> <img id=\"search-icon\" src=\"" + __webpack_require__(33) + "\" alt=\"Run Search\"> </button> </div>";
    ...
    /***/function (module, exports, __webpack_require__) {
        ...
        module.exports = "<style>" + __webpack_require__(19) + "</style> <div class=\"byu-user-wrapper\"> <div class=\"no-user slot-wrapper\"> <img class=\"not-mobile\" src=\"" + __webpack_require__(37) + "\"> <img class=\"mobile\" src=\"" + __webpack_require__(36) + "\"> <span class=\"text slot-wrapper\"> <slot name=\"login\">Sign In</slot> </span> </div> <div class=\"has-user\"> <span class=\"name slot-wrapper\"> <slot name=\"user-name\" id=\"user-name\"></slot> </span> <img class=\"not-mobile\" src=\"" + __webpack_require__(35) + "\"> <img class=\"mobile\" src=\"" + __webpack_require__(34) + "\"> <span class=\"logout slot-wrapper\"> <slot name=\"logout\">Sign Out</slot> </span> </div> </div>";
