...
(function () {
    ...
    /***/function (module, __webpack_exports__, __webpack_require__) {
        ...
        var BYUMenu = function (_HTMLElement5) {
            ...
            _createClass(BYUMenu, [{
                ...
                set: function set(show) {
                    toggleClass(this.shadowRoot.querySelector('.byu-menu-more-menu'), 'byu-menu-more-expanded', show);
                }
            }]);
            ...
            _createClass(BYUMenu, [{
                ...
                value: function connectedCallback() {
                    ...
                    // when the overlay is click then hide the more menu
                    this.shadowRoot.querySelector('.byu-menu-fixed-overlay').addEventListener('click', function () {
        ...
        function updateMoreMenuState(component) {
            ...
            var innerNav = component.shadowRoot.querySelector('.inner-nav');
    ...
    /***/function (module, exports, __webpack_require__) {
        ...
        // module
        exports.push([module.i, ":host{display:block;width:100%;height:auto;background:#fff;opacity:.88;border-bottom:1px solid #ccc}.outer-nav{display:flex;flex-direction:row;flex-wrap:nowrap;align-items:center;justify-content:flex-start;padding:0}.inner-nav{width:100%;display:table}::slotted(*){width:16.66%;text-decoration:none!important;font-size:13px!important;font-family:Gotham A,Gotham B,Helvetica,sans-serif!important;font-weight:400!important;text-transform:uppercase!important;color:#fff!important;cursor:pointer!important;color:#002e5d!important;height:35px!important;display:table-cell;vertical-align:middle!important;text-align:center!important;padding:0 6px!important}.byu-menu-more-menu{display:none;position:relative;height:35px;width:16.66%}.byu-menu-more-menu .byu-menu-more{text-decoration:none!important;font-size:13px!important;font-family:Gotham A,Gotham B,Helvetica,sans-serif!important;font-weight:400!important;text-transform:uppercase!important;color:#fff!important;cursor:pointer!important;color:#002e5d!important;height:35px!important;display:table-cell;vertical-align:middle!important;text-align:center!important;padding:0 6px!important;position:absolute;top:0;left:0;right:0;bottom:0;padding-top:11px!important;padding-left:15px!important;padding-right:15px!important;text-align:left!important;box-sizing:border-box}.byu-menu-more-menu .byu-menu-more svg{fill:#002e5d;position:absolute;right:15px}.byu-menu-more-menu .byu-menu-more-items{display:none;position:absolute;top:35px;left:0;right:0;z-index:2;background:#fff;box-shadow:0 0 2px 0 rgba(0,0,0,.75);padding:6px 0 12px}.byu-menu-more-menu .byu-menu-more-items ::slotted(*){width:100%;text-decoration:none!important;font-size:13px!important;font-family:Gotham A,Gotham B,Helvetica,sans-serif!important;font-weight:400!important;text-transform:uppercase!important;color:#fff!important;cursor:pointer!important;color:#002e5d!important;height:35px!important;display:table-cell;vertical-align:middle!important;text-align:center!important;padding:0 6px!important;display:block;text-align:left!important;box-sizing:border-box;padding:11px 15px!important}.byu-menu-more-visible .byu-menu-more-menu{display:table-cell}.byu-menu-more-visible .byu-menu-more-menu.byu-menu-more-expanded{background:#e6e6e6;box-shadow:0 0 2px 0 rgba(0,0,0,.75)}.byu-menu-more-visible .byu-menu-more-menu.byu-menu-more-expanded .byu-menu-more-items{display:block}.byu-menu-more-visible .byu-menu-more-menu.byu-menu-more-expanded .byu-menu-fixed-overlay{position:fixed;top:0;bottom:0;left:0;right:0;z-index:1;background:rgba(255,0,0,.5)}:host(.mobile-view){padding:15px 0}:host(.mobile-view) .byu-menu-more-items{position:static}:host(.mobile-view) ::slotted(*){display:block!important;text-align:left!important;padding:15px 30px!important;height:auto!important;width:100%;position:static;box-sizing:border-box}:host(.mobile-view) .byu-menu-more{display:none}:host(.mobile-view) .byu-menu-more-menu{display:block;width:100%;box-shadow:none;position:static;height:auto}:host(.mobile-view) .byu-menu-more-menu .byu-menu-more-items{display:block;box-shadow:none;padding:0}:host(.mobile-view) .byu-menu-more-menu .byu-menu-more-items ::slotted(*){display:block!important;text-align:left!important;padding:15px 30px!important;height:auto!important;width:100%;position:static;box-sizing:border-box}:host(.mobile-view) .byu-menu-more-menu.byu-menu-more-expanded{box-shadow:none}:host(.mobile-view) .byu-menu-more-menu.byu-menu-more-expanded .byu-menu-fixed-overlay{display:none!important}", ""]);
    ...
    /***/function (module, exports, __webpack_require__) {
        ...
        module.exports = "<style>" + __webpack_require__(14) + "</style> <link type=\"text/css\" rel=\"stylesheet\" href=\"https://cloud.typography.com/75214/6517752/css/fonts.css\" media=\"all\"> <nav class=\"outer-nav\"> <div class=\"inner-nav\"> <slot class=\"byu-menu-items\"></slot> <div class=\"byu-menu-more-menu\"> <a href=\"javascript: void 0\" class=\"byu-menu-more\"> More <svg width=\"15\" height=\"15\" viewBox=\"0 0 1792 1792\" xmlns=\"http://www.w3.org/2000/svg\"><path d=\"M1683 808l-742 741q-19 19-45 19t-45-19l-742-741q-19-19-19-45.5t19-45.5l166-165q19-19 45-19t45 19l531 531 531-531q19-19 45-19t45 19l166 165q19 19 19 45.5t-19 45.5z\"/></svg> </a> <div class=\"byu-menu-more-items\"> <slot name=\"more\"></slot> </div> <div class=\"byu-menu-fixed-overlay\"></div> </div> </div> </nav> <div id=\"stylePlaceHolder\"></div>";
